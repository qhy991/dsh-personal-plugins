	...
	factory: (require) => {
		...
		*/
		...
		var _dsh_css_64557083eb0f58b9_default = {
			...
			"authoredBadge": "sYJ4xq_authoredBadge",
			"authoringBadge": "sYJ4xq_authoringBadge",
			"authoringChain": "sYJ4xq_authoringChain",
			"badge": "sYJ4xq_badge",
			...
			"body": "sYJ4xq_body",
			"callActivities": "sYJ4xq_callActivities",
			"callDetail": "sYJ4xq_callDetail",
			"callDetailMeta": "sYJ4xq_callDetailMeta",
			"callLabel": "sYJ4xq_callLabel",
			"callMessages": "sYJ4xq_callMessages",
			"callMeta": "sYJ4xq_callMeta",
			"callStatus": "sYJ4xq_callStatus",
			"callTreeItem": "sYJ4xq_callTreeItem",
			...
			"excludedBadge": "sYJ4xq_excludedBadge",
			"executionTree": "sYJ4xq_executionTree",
			"failureBadge": "sYJ4xq_failureBadge",
			"fitBadge": "sYJ4xq_fitBadge",
			"gateBadge": "sYJ4xq_gateBadge",
			"header": "sYJ4xq_header",
			"hostStep": "sYJ4xq_hostStep",
			"hostTreeItem": "sYJ4xq_hostTreeItem",
			...
			"roundDecision": "sYJ4xq_roundDecision",
			"roundFacts": "sYJ4xq_roundFacts",
			"roundHead": "sYJ4xq_roundHead",
			"roundHistory": "sYJ4xq_roundHistory",
			"roundNode": "sYJ4xq_roundNode",
			"roundTree": "sYJ4xq_roundTree",
			"roundVerdict": "sYJ4xq_roundVerdict",
			"roundWorkflow": "sYJ4xq_roundWorkflow",
			"routeBadge": "sYJ4xq_routeBadge",
			"row": "sYJ4xq_row",
			"rowHead": "sYJ4xq_rowHead",
			"rowLabel": "sYJ4xq_rowLabel",
			"rows": "sYJ4xq_rows",
			...
			"selectedBadge": "sYJ4xq_selectedBadge",
			"sessionId": "sYJ4xq_sessionId",
			"statusTail": "sYJ4xq_statusTail",
			"stopNode": "sYJ4xq_stopNode",
			...
			"title": "sYJ4xq_title",
			"treeGroup": "sYJ4xq_treeGroup",
			"treeNode": "sYJ4xq_treeNode",
			"treeNodeButton": "sYJ4xq_treeNodeButton",
			"view": "sYJ4xq_view",
			"warningCount": "sYJ4xq_warningCount",
			"workflowBranch": "sYJ4xq_workflowBranch",
			"workflowBranches": "sYJ4xq_workflowBranches",
			"workflowIdentity": "sYJ4xq_workflowIdentity",
			"workflowName": "sYJ4xq_workflowName",
			"workflowPhase": "sYJ4xq_workflowPhase",
			"workflowPhaseBody": "sYJ4xq_workflowPhaseBody",
			"workflowPhaseIndex": "sYJ4xq_workflowPhaseIndex",
			"workflowResult": "sYJ4xq_workflowResult",
			"workflowRoot": "sYJ4xq_workflowRoot",
			"workflowTree": "sYJ4xq_workflowTree",
			"workspaceBadge": "sYJ4xq_workspaceBadge"
		};
		//#endregion
		...
		const css = ".NjcLBq_card{border:1px solid var(--dsw-alias-border-normal,#d9dce3);background:var(--dsw-alias-bg-module-platform,#fff);border-radius:12px;margin:8px 0 14px;padding:14px}.NjcLBq_header,.NjcLBq_footer,.NjcLBq_facts{align-items:center;display:flex}.NjcLBq_header{justify-content:space-between;gap:12px}.NjcLBq_eyebrow{color:var(--dsw-alias-fg-secondary,#667085);font-size:12px}.NjcLBq_title{margin-top:2px;font-weight:650}.NjcLBq_status{background:var(--dsw-alias-bg-base-hover,#f2f4f7);border-radius:999px;padding:3px 8px;font-size:12px}.NjcLBq_objective,.NjcLBq_next{margin:10px 0 0;line-height:1.45}.NjcLBq_facts{color:var(--dsw-alias-fg-secondary,#667085);flex-wrap:wrap;gap:6px 12px;margin-top:10px;font-size:12px}.NjcLBq_progress{margin-top:12px}.NjcLBq_progressTrack{background:var(--dsw-alias-bg-base-hover,#eaecf0);border-radius:999px;height:4px;overflow:hidden}.NjcLBq_progressTrack>span{border-radius:inherit;background:var(--dsw-alias-fg-business-primary,#4f46e5);height:100%;transition:width .16s;display:block}.NjcLBq_steps{grid-template-columns:repeat(auto-fit,minmax(92px,1fr));gap:8px;margin:10px 0 0;padding:0;font-size:12px;list-style:none;display:grid}.NjcLBq_steps li{align-items:center;gap:6px;min-width:0;display:flex}.NjcLBq_dot{background:#98a2b3;border-radius:50%;flex:none;width:8px;height:8px}.NjcLBq_steps li[data-step-status=active] .NjcLBq_dot{background:#f79009}.NjcLBq_steps li[data-step-status=completed] .NjcLBq_dot{background:#12b76a}.NjcLBq_steps li[data-step-status=failed] .NjcLBq_dot{background:#f04438}.NjcLBq_next{background:var(--dsw-alias-bg-base-hover,#f7f8fa);border-radius:8px;padding:8px 10px;font-size:13px}.NjcLBq_footer{justify-content:space-between;gap:12px;margin-top:12px}.NjcLBq_open{border:1px solid var(--dsw-alias-border-normal,#d0d5dd);color:inherit;cursor:pointer;background:0 0;border-radius:8px;padding:6px 10px}.NjcLBq_open:disabled{cursor:default;opacity:.5}.NjcLBq_footer code{color:var(--dsw-alias-fg-secondary,#667085);text-overflow:ellipsis;white-space:nowrap;font-size:10px;overflow:hidden}";
		...
		var _dsh_css_5e80a47b73f6677b_default = {
			"card": "NjcLBq_card",
			"dot": "NjcLBq_dot",
			"eyebrow": "NjcLBq_eyebrow",
			"facts": "NjcLBq_facts",
			"footer": "NjcLBq_footer",
			"header": "NjcLBq_header",
			"next": "NjcLBq_next",
			"objective": "NjcLBq_objective",
			"open": "NjcLBq_open",
			"progress": "NjcLBq_progress",
			"progressTrack": "NjcLBq_progressTrack",
			"status": "NjcLBq_status",
			"steps": "NjcLBq_steps",
			"title": "NjcLBq_title"
		};
		//#endregion
		...
		var KersorViewerStore = class {
			...
			*/
			selectClassic(sessionDir) {
				...
				this.selected = sessionDir === void 0 ? void 0 : [...this.state.snapshot?.runs ?? []].filter((ref) => ref.sessionDir === sessionDir).sort((left, right) => (right.round ?? 0) - (left.round ?? 0))[0]?.runDir;
