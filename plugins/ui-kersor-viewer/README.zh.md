...
- **backlog 跟随选择** —— 清单与来源健康实时更新；选中 run 的折叠详情在选择／打开时读取，并在重连后刷新。
